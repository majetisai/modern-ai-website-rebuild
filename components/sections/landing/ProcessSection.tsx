    ...
    <section className="py-20 md:py-28 bg-[#faf8ff]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-[#ede9fe] md:left-1/2 md:-translate-x-1/2" />
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 shrink-0 md:absolute md:left-1/2 md:-translate-x-1/2 md:top-5">
                    <div className="w-16 h-16 rounded-full bg-[#7c3aed] flex items-center justify-center text-white font-extrabold text-xl shadow-lg">
                      {step.step}
                    </div>
                  </div>
                    ...
                    <div className="card p-6">
                      <div className={`flex items-center gap-3 mb-3 ${isEven ? "md:flex-row-reverse" : ""}`}>
                        ...
                        <div>
                          ...
                          <span className="text-[#7c3aed] text-xs font-semibold">{step.duration}</span>
                        </div>
                      </div>
